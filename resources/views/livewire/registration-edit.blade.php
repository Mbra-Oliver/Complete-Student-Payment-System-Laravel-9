<div class="p-3 bg-white shadow-md">
    ...
    <form method="POST" wire:submit.prevent='update'>
        ...
        <div>
            ...
            <input id="" class="block mt-1 w-full rounded-md borger-gray-300"  type="text" wire:model.lazy='matricule' readonly />
        </div>
        ...
        <div>
            ...
            <span class="block p-2 bg-red-500 text-white rounded-sm shadow">{{ $error_text }}</span>
                ...
                <div class="flex items-center justify-end mt-4">
                   ...
                   <button class="ml-4 p-2 bg-green-300 rounded-md text-white" {{ $class_id != null ? '': 'disabled' }}>
                        Update registration
                      </button>    
